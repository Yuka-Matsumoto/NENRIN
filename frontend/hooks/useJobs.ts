...
//     description:
//       "We are looking for an experienced software engineer to develop innovative applications.",
...
//     description:
//       "Seeking a data analyst to manage large data sets and provide insights.",
...
//     description:
//       "Looking for a creative marketing specialist to develop campaigns and manage social media.",
...
//         (job) => job.title.includes(title) && job.location.includes(location)
//       );
