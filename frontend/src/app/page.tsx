  ...
  return (
    <div className="flex items-center justify-center min-h-screen" style={{ paddingTop: '250px' }}>
      <main className="text-center space-y-6">
        ...
        <p className="text-3xl" style={{ paddingTop: '100px' }}><span className="text-brown-700 font-bold">N E N R I N</span>は、主に退職後のシニアの皆様がこれまで培ったスキルや経験を活かして新たなサービスを提供できる場です。</p>
        <p className="text-3xl">一方で、自治体、団体、企業様はシニア様の力を活用して地域や社会に貢献できます。</p>
        <p className="text-3xl">シニア様と社会全体をつなげることで、退職後も世代を超えて交流ができる新しい機会を提供します。</p>
        {/* <img src="" alt="" /> */}
        {/* <div className="flex flex-wrap justify-center mt-12" style={{ paddingTop: '500px' }}>
          <div className="w-full md:w-1/2 text-center md:pr-8 mb-8 md:mb-0">
        ...
        {/* <div className="flex flex-wrap justify-center mt-12" style={{ paddingTop: '250px' }}>
          <div className="w-full md:w-1/2 text-center md:pr-8 mb-8 md:mb-0">
        ...
        <div className="" style={{ paddingBottom: '250px', paddingTop: '200px' }}>
