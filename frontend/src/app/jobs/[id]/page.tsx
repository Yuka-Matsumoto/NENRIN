...
const JobDetailPage = () => {
  ...
  useEffect(() => {
    const mockJob = {
      ...
      description: "Looking for a caregiver with experience in elderly care.",
      location: "Tokyo, Japan",
      salary: "3000 JPY/hour",
      status: "Open",
    ...
    const mockProfile = {
      id: "ce4ac2ba-bfe9-42de-8b67-3e1c56ce769f",
      name: "John Doe",
      experience: "5 years in caregiving",
      skills: ["Nursing", "Cooking", "Housekeeping"],
    };
