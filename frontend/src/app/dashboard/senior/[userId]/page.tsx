...
//                 <div className="bg-white rounded-lg shadow-md p-6 md:p-8 lg:p-10">
//                     <div className="flex justify-between items-center mb-8">
//                         <h2 className="text-3xl font-bold text-teal-600">シニアユーザー用ダッシュボード</h2>
//                         <UserCircleIcon />
//                     </div>
...
//                             { icon: ListIcon, text: "応募求人の一覧", path: "/jobs/applications" },
//                             { icon: BriefcaseIcon, text: "求人検索", path: "/jobs" },
//                         ].map((item, index) => (
//                             <button
//                                 key={index}
//                                 onClick={() => handleButtonClick(item.path)}
...
// src/app/dashboard/senior/[userId]/page.tsx
import React from 'react';
import Head from 'next/head';
import RootLayout from '../../../layout';
import CustomHeader from "../../../../../components/layout/CustomHeader";
import Dashboard from '../../../../../components/Dashboard/SeniorDashboard';
...
const SeniorDashboardPage: React.FC<PageProps> = ({ params }) => {
    return (
        <>
            <Head>
                <title>Dashboard - N E N R I N</title>
                <meta name="description" content="Dashboard for N E N R I N platform" />
            </Head>
            <RootLayout header={<CustomHeader />}>
...
export default SeniorDashboardPage;
